                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Tingkat Hukuman</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="col-12 text-right">
                                                ...
                                                <a href="{{route('tambah_data_pelanggaran_faktor_utama')}}" class="btn btn-sm btn-primary">Next</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
