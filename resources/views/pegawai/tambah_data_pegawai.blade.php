                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="#">Input Data Pegawai</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('simpan_data_pegawai')}}" method="post">
                            @csrf
                            @method("post")
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="jabatan"
                                                ...
                                                <option  disabled value="Kepala Bagian">Kepala Bagian</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
